...
import { X, Info, Key, Code, Users, Globe, ArrowRight, ArrowLeft } from 'lucide-react';
...
interface StackBlitzInfoModalProps {
  isOpen: boolean;
  onClose: () => void;
}
        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <div className="flex gap-3">
              ...
              <Button
                onClick={() => {
                  window.open('https://stackblitz.com/docs/guides/api-keys', '_blank');
                  onClose();
                }}
                className="flex-1"
              >
